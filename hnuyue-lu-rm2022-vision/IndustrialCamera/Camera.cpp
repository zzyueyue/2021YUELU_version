...
namespace hnurm
{
    ...
    void HKcam::SetParam()
    {
        ...
        FileStorage CameraParam("/home/rm/hnuyue-lu-rm2022-vision/CameraParam.xml", FileStorage::READ);
    ...
    bool HKcam::GetFlame(ImgInfo& img)
    {
        ...
        img.img=cv::Mat(stImageInfo.nHeight,stImageInfo.nWidth,CV_8UC3,pData);
